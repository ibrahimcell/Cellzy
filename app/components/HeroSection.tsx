...
export default function HeroSection() {
  ...
  return (
    ...
    >
      {/* Phone colour carousel — full background */}
      ...
      {/* Top fade — bleeds into navbar */}
      <div
        style={{
          position: "absolute",
          inset: "0 0 auto",
          height: 200,
          background: "linear-gradient(to bottom, rgba(245,245,247,1) 0%, rgba(245,245,247,0.72) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 2,
        }}
      />
      ...
      <div
        style={{
          ...
          inset: "auto 0 0",
          height: "52%",
          background: "linear-gradient(to top, rgba(245,245,247,1) 0%, rgba(245,245,247,0.94) 30%, rgba(245,245,247,0.5) 60%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 2,
        }}
      />
      ...
      <motion.div
        style={{
          ...
          alignItems: "center",
          textAlign: "center",
          padding: "0 24px clamp(52px, 10vw, 96px)",
        }}
      >
        <motion.p
          ...
          style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.28em", textTransform: "uppercase", color: "#aeaeb2", marginBottom: 18 }}
        >
          iPhone 17 Pro Max &nbsp;·&nbsp; Galaxy S26 Ultra &nbsp;·&nbsp; Expert Repairs
        </motion.p>
      ...
      >
        ...
        <motion.div
          ...
          style={{ width: 1, height: 32, borderRadius: 999, background: "linear-gradient(to bottom, rgba(0,0,0,0.2), transparent)" }}
        />
      </motion.div>
    </section>
  );
